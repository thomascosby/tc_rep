...
# legacy
find /mn_raid*/*jobs/Archive\ Staging/*/*/Z_Delete\ At\ Archive -depth -exec rm -Rfv {} \; >> $cleanupLogPath/Z_Delete_$dateStamp.log

# GFS
find /mn_raid*/*jobs/Archive\ Staging/*/*/999_Delete_at_Archive -depth -exec rm -Rfv {} \; >> $cleanupLogPath/Z_Delete_$dateStamp.log

# legacy Other Clients
#find /mn_raid2/otherclientsjobs/Archive\ Staging/*/*/*/Z_Delete\ At\ Archive -depth -exec rm -Rfv {} \; >> $cleanupLogPath/Z_Delete_$dateStamp.log

# GFS Other Clients
find /mn_raid2/otherclientsjobs/Archive\ Staging/*/*/*/999_Delete_at_Archive -depth -exec rm -Rfv {} \; >> $cleanupLogPath/Z_Delete_$dateStamp.log
...
# all clients
find /mn_raid*/*jobs/Archive\ Staging/*/*/config -depth -exec rm -Rfv {} \; >> /usr/schawk/logs/archiving/cleanup/config_$dateStamp.log

# GFS Other Clients
find /mn_raid2/otherclientsjobs/Archive\ Staging/*/*/*/config -depth -exec rm -Rfv {} \; >> /usr/schawk/logs/archiving/cleanup/config_$dateStamp.log
...
# all clients
find /mn_raid*/*jobs/Archive\ Staging/*/*/temp -depth -exec rm -Rfv {} \; >> $cleanupLogPath/temp_$dateStamp.log

# GFS Other Clients
find /mn_raid2/otherclientsjobs/Archive\ Staging/*/*/*/temp -depth -exec rm -Rfv {} \; >> $cleanupLogPath/temp_$dateStamp.log
...
# all clients
find /mn_raid*/*jobs/Archive\ Staging/*/*/incoming_data -depth -exec rm -Rfv {} \; >> /usr/schawk/logs/archiving/cleanup/incoming_data_$dateStamp.log

# GFS Other Clients
find /mn_raid2/otherclientsjobs/Archive\ Staging/*/*/*/incoming_data -depth -exec rm -Rfv {} \; >> /usr/schawk/logs/archiving/cleanup/incoming_data_$dateStamp.log
