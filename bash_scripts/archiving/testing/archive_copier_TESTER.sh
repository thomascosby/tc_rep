...
# Dan B - v1.05 - 09.13.13 - letting user specify the year
...
echo "### ARCHIVE COPYING BEGINS: "`date`" ###";echo "" >> $LOGPATH
##################################
#  GENERAL MILLS                 #
##################################         
...
DIRS_ARC_YR_BEF=`ls -1 /s2/jobsarchive/dialarchive/Jobs\ Archive/$theYear | wc -l`
THISTIME=`(time /bin/cp -rfp /r2/dialjobs/Dial\ Jobs\ WIP/Archive\ Staging/* /s2/jobsarchive/dialarchive/Jobs\ Archive/$theYear/) 2>&1 | grep real`
REALTIME=`(echo $THISTIME | cut -f 2 -d ' ')`
echo "    Copy Completed in "$REALTIME" ***" >> $LOGPATH
DIRS_ARC_YR_AFT=`ls -1 /s2/jobsarchive/dialarchive/Jobs\ Archive/$theYear | wc -l`
DIRS_COPIED=$((DIRS_ARC_YR_AFT-DIRS_ARC_YR_BEF))
echo "    ITEMS IN ARCHIVE STAGING: "$DIRS_ARC_STG >> $LOGPATH
echo "    ITEMS ADDED TO ARCHIVE: "$DIRS_COPIED >> $LOGPATH
echo >> $LOGPATH
...
DIRS_ARC_YR_BEF=`ls -1 /s2/jobsarchive/diamondfoodsarchive/Jobs\ Archive/$theYear | wc -l`
THISTIME=`(time /bin/cp -rfp /r2/diamondfoodsjobs/Diamond\ Foods\ Jobs\ WIP/Archive\ Staging/* /s2/jobsarchive/diamondfoodsarchive/Jobs\ Archive/$theYear/) 2>&1 | grep real`
REALTIME=`(echo $THISTIME | cut -f 2 -d ' ')`
echo "    Copy Completed in "$REALTIME" ***" >> $LOGPATH
DIRS_ARC_YR_AFT=`ls -1 /s2/jobsarchive/diamondfoodsarchive/Jobs\ Archive/$theYear | wc -l`
DIRS_COPIED=$((DIRS_ARC_YR_AFT-DIRS_ARC_YR_BEF))
echo "    ITEMS IN ARCHIVE STAGING: "$DIRS_ARC_STG >> $LOGPATH
echo "    ITEMS ADDED TO ARCHIVE: "$DIRS_COPIED >> $LOGPATH
echo >> $LOGPATH
...
DIRS_ARC_YR_BEF=`ls -1 /s2/jobsarchive/familydollararchive/Jobs\ Archive/$theYear | wc -l`
THISTIME=`(time /bin/cp -rfp /r2/familydollarjobs/Family\ Dollar\ Jobs\ WIP/Archive\ Staging/* /s2/jobsarchive/familydollararchive/Jobs\ Archive/$theYear/) 2>&1 | grep real`
REALTIME=`(echo $THISTIME | cut -f 2 -d ' ')`
echo "    Copy Completed in "$REALTIME" ***" >> $LOGPATH
DIRS_ARC_YR_AFT=`ls -1 /s2/jobsarchive/familydollararchive/Jobs\ Archive/$theYear | wc -l`
DIRS_COPIED=$((DIRS_ARC_YR_AFT-DIRS_ARC_YR_BEF))
echo "    ITEMS IN ARCHIVE STAGING: "$DIRS_ARC_STG >> $LOGPATH
echo "    ITEMS ADDED TO ARCHIVE: "$DIRS_COPIED >> $LOGPATH
echo >> $LOGPATH
...
DIRS_ARC_YR_BEF=`ls -1 /s2/jobsarchive/ghbarchive/Jobs\ Archive/$theYear | wc -l`
THISTIME=`(time /bin/cp -rfp /r2/ghbjobs/GHB\ Jobs\ WIP/Archive\ Staging/* /s2/jobsarchive/ghbarchive/Jobs\ Archive/$theYear/) 2>&1 | grep real`
REALTIME=`(echo $THISTIME | cut -f 2 -d ' ')`
echo "    Copy Completed in "$REALTIME" ***" >> $LOGPATH
DIRS_ARC_YR_AFT=`ls -1 /s2/jobsarchive/ghbarchive/Jobs\ Archive/$theYear | wc -l`
DIRS_COPIED=$((DIRS_ARC_YR_AFT-DIRS_ARC_YR_BEF))
echo "    ITEMS IN ARCHIVE STAGING: "$DIRS_ARC_STG >> $LOGPATH
echo "    ITEMS ADDED TO ARCHIVE: "$DIRS_COPIED >> $LOGPATH
echo >> $LOGPATH
...
echo "### ARCHIVE COPYING COMPLETE: "`date`" ###";echo "" >> $LOGPATH
