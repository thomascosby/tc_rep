...
SOURCEVOL="/mn_raid2/hormel/Assets/Hormel"
...
# perform rsync
$RSYNC -rtvzh --timeout=600 --delete --max-delete=100 --stats --exclude '/Assets/Staging/' --exclude 'PDF\ Library/' --exclude '*_P.psd' --exclude '*_p.psd' --exclude '*_P.PSD' --exclude '*_p.PSD' --exclude '*_P?.psd' --exclude '*_p?.psd' --exclude '*_P?.PSD' --exclude '*_p?.PSD' --exclude '*_P??.psd' --exclude '*_p??.psd' --exclude '*_P??.PSD' --exclude '*_p??.PSD' --exclude '*_P???.psd' --exclude '*_p???.psd' --exclude '*_P???.PSD' --exclude '*_p???.PSD' --exclude '.*' --exclude '1900' --exclude '2000' --exclude '2100' --exclude '2200' --exclude '2300' --exclude '2400' --exclude '2500' --exclude '2600' --exclude '2700' --exclude '2800' --exclude '2900' --exclude '3000' --exclude '3100' --exclude '3200' --exclude '3300' --exclude '3400' --exclude '3500' --exclude '3600' --exclude 'HOR0000-1999' "$SOURCEVOL" "$DESTVOL" 2>&1 | tee >> $DAILY_LOG
